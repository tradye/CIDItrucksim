...
#ifndef MODULES_PLANNING_CONSTRAINT_CHECKER_SEMI_TRAILER_TRUCK_COLLISION_CHECKER_H_
#define MODULES_PLANNING_CONSTRAINT_CHECKER_SEMI_TRAILER_TRUCK_COLLISION_CHECKER_H_
...
class SemiTrailerTruckCollisionChecker {
 public:
  explicit SemiTrailerTruckCollisionChecker(
