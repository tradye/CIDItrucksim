function [lat_err,lat_err_rate,heading_err,heading_err_rate, ...
    ...
    trail_heading_err, trail_heading_err_rate, station_err,speed_err,i] = ...
    ComputeErrors(xk,yk,xl,yl,hk,hl,linear_v_,avk,avl)
   ...
   station_err = 0.0;
   speed_err = linear_v_ -  target_points.v(i);
end
