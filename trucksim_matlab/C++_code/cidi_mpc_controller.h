...
#ifndef MODULES_CONTROL_CONTROLLER_CIDI_MPC_CONTROLLER_H_
#define MODULES_CONTROL_CONTROLLER_CIDI_MPC_CONTROLLER_H_
 ...
 */
class CIDIMPCController : public Controller {
 public:
  /**
   * @brief constructor
   */
 ...
 protected:
  ...
  // trailer lateral error ,trailer lateral error rate, trailer heading error ,
  // trailer heading error rate
  const int basic_state_size_ = 8;
...
//   Eigen::MatrixXd matrix_state_;
  ...
  std::unique_ptr<Interpolation1D> trailer_lat_err_interpolation_;//new added for trailer

  std::unique_ptr<Interpolation1D> trailer_heading_err_interpolation_;//new added for trailer

  // MeanFilter heading_rate_filter_;
  common::MeanFilter lateral_error_filter_;
  common::MeanFilter heading_error_filter_;
  // MeanFilter for trailer
  common::MeanFilter trailer_lateral_error_filter_;
  common::MeanFilter trailer_heading_error_filter_;
