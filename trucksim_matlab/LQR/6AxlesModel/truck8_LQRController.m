%% truck8_LQRController S-function 2018420 xuhao husibo
...
function [sys,x0,str,ts] = truck8_LQRController(t,x,u,flag)
...
%             truck_path_points.v(i) =  truck_path_points.v(i) - 10;
    ...
    matrix_Q(1,1) = 0.72; %  0.01145 0.58245
    matrix_Q(2,2) = 0.00;
    matrix_Q(3,3) = 3.0000; %  0.0120  4.0000
    matrix_Q(4,4) = 0.0000;
    
    matrix_Q(5,5) = 0.0; %  0.01145 0.58245
    matrix_Q(6,6) = 0.00;
    matrix_Q(7,7) = 0.000; %  0.0120  4.0000
    matrix_Q(8,8) = 0.0000;
