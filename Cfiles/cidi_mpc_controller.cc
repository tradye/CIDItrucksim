...
CIDIMPCController::CIDIMPCController() : name_("MPC Controller") {
...
void CIDIMPCController::ProcessLogs(const SimpleMPCDebug *debug,
...
Status CIDIMPCController::Init(const ControlConf *control_conf) {
  ...
  // truck_model_6axles_.LoadModelConf(control_conf);
...
void CIDIMPCController::LoadMPCGainScheduler(
...
Status CIDIMPCController::ComputeControlCommand(
  ...
  // TruckModel6Axles truck_model;
  // TruckModel6Axles::LoadModelConf(control_conf);
  // apollo::control::TruckModel6Axles::LoadModelConf(control_conf);
...
void CIDIMPCController::LoadControlCalibrationTable(
    const MPCControllerConf &mpc_controller_conf) {
...
void CIDIMPCController::UpdateStateAnalyticalMatching(SimpleMPCDebug *debug) {
...
void CIDIMPCController::UpdateMatrix(SimpleMPCDebug *debug) {
...
void CIDIMPCController::FeedforwardUpdate(SimpleMPCDebug *debug) {
...
void CIDIMPCController::ComputeLongitudinalErrors(
