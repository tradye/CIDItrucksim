...
class CIDIMPCController : public Controller {
 ...
 protected:
  ...
  TruckModel6Axles truck_model_6axles_;
  ...
  // trailer lateral  error, trailer_lateral error rate, trailer_heading error, trailer_heading error rate,
  // station error, velocity error,
  const int basic_state_size_ = 10;// 此处8还是10？保持不变的话就是10，将纵向去掉的话就是8
...
#endif  // MODULES_CONTROL_CONTROLLER_CIDI_MPC_CONTROLLER_H_
